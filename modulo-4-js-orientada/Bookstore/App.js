...
module.exports = class App {
   ...
   createPosters(name,description,heigth,width, price, inStock){
    const poster = new Posters(name, description, heigth, width, price, inStock)
